...
public final class ProxyStatusCommandRegistration {

    private final ProxyServer proxyServer;
    private final Object plugin;
    private final ProxyStatusCommand command;

    private CommandMeta commandMeta;

    public ProxyStatusCommandRegistration(
