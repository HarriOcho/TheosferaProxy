...
import com.theosfera.proxy.session.PlayerPresenceRenewalScheduler;
...
public final class VelocityPlayerPresenceRenewalScheduler
        implements PlayerPresenceRenewalScheduler {

    private final ProxyServer proxyServer;
    private final Object plugin;

    public VelocityPlayerPresenceRenewalScheduler(
    ...
    public Handle schedule(Runnable task, Duration interval) {
        ...
        if (scheduledTask == null) {
            throw new IllegalStateException(
                    "Velocity scheduler returned null player presence renewal task"
            );
        }
