...
import com.theosfera.proxy.session.PlayerSessionRenewalScheduler;
...
public final class VelocityPlayerSessionRenewalScheduler
        implements PlayerSessionRenewalScheduler {

    private final ProxyServer proxyServer;
    private final Object plugin;

    public VelocityPlayerSessionRenewalScheduler(
    ...
    public Handle schedule(Runnable task, Duration interval) {
        ...
        if (scheduledTask == null) {
            throw new IllegalStateException(
                    "Velocity scheduler returned null player session renewal task"
            );
        }
